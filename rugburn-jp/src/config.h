...
/*
 * When 1, Rugburn does not disarm GameGuard / HackShield:
 *  - GameGuard.des is allowed to start (no CreateProcessA fake)
 *  - client GG/HS check routines are left intact (no C3 / jmp $+5 patches)
 * URL/port rewrites, PANGYA_ARG, and other hooks still apply.
 */
#ifndef RUGBURN_ENABLE_GAMEGUARD
#define RUGBURN_ENABLE_GAMEGUARD 1
#endif
